...
| sed -e s/MAX_EVTS/-1/ \
| sed -e s/INPUT_POOLSOURCE/QCDpt15_plus_5PU_Full_Poisson/ \
| sed -e s/OUTPUT_FILENAME/closureAnalysis_QCDpt15_plus_5PU_Full_Poisson_corrected_PV_Lumi/ \
| sed -e s/DO_CORR/True/ \
| sed -e s/DO_PVS/True/ \
| sed -e s/MAX_NPVS/8/ \
| sed -e s/PV_COLLECTION/offlinePrimaryVertices/ \
...
cmsRun $CONFIG_FILE >& QCDpt15_plus_5PU_Full_Poisson_corrected_PV_Lumi.log 
