...
# | sed -e s/OUTPUT_FILENAME/closureAnalysis_QCDpt15_NN/ \
...
# | sed -e s/OUTPUT_FILENAME/closureAnalysis_QCDpt15_plus_1PU_InTime_Poisson/ \
# | sed -e s/DO_CORR/False/ \
# | sed -e s/DO_PVS/False/ \
# | sed -e s/MAX_NPVS/4/ \
# | sed -e s/PV_COLLECTION/offlinePrimaryVertices/ \
...
# | sed -e s/MAX_EVTS/-1/ \
# | sed -e s/INPUT_POOLSOURCE/QCDpt15_plus_1PU_InTime_Poisson/ \
# | sed -e s/OUTPUT_FILENAME/closureAnalysis_QCDpt15_plus_1PU_InTime_Poisson_corrected_Avg_Lumi/ \
...
# | sed -e s/OUTPUT_FILENAME/QCDpt15_plus_1PU_Full_Poisson/ \
# | sed -e s/OFFSET_CORRECTION/False/ \
# | sed -e s/NUMBER_OF_PU/1PU/ \
# > $CONFIG_FILE
# 
...
#==========================================================
# echo "`/bin/date` >> QCDpt15_plus_1PU_Full_Poisson_corrected analysis started..."
# 
# cat $CONFIG_FILE_TEMPLATE \
# | sed -e s/INPUT_POOLSOURCE/QCDpt15_plus_1PU_Full_Poisson/ \
# | sed -e s/OUTPUT_FILENAME/QCDpt15_plus_1PU_Full_Poisson_corrected/ \
# | sed -e s/OFFSET_CORRECTION/True/ \
# | sed -e s/NUMBER_OF_PU/1PU/ \
# > $CONFIG_FILE
# 
# cmsRun $CONFIG_FILE >& QCDpt15_plus_1PU_Full_Poisson_corrected.log 
# 
# echo "`/bin/date` >> QCDpt15_plus_1PU_Full_Poisson_corrected analysis completed!"
#==========================================================
...
| sed -e s/OUTPUT_FILENAME/closureAnalysis_QCDpt15_plus_2PU_InTime_Poisson/ \
| sed -e s/DO_CORR/False/ \
| sed -e s/DO_PVS/False/ \
| sed -e s/MAX_NPVS/4/ \
| sed -e s/PV_COLLECTION/offlinePrimaryVertices/ \
...
| sed -e s/MAX_EVTS/-1/ \
| sed -e s/INPUT_POOLSOURCE/QCDpt15_plus_2PU_InTime_Poisson/ \
| sed -e s/OUTPUT_FILENAME/closureAnalysis_QCDpt15_plus_2PU_InTime_Poisson_corrected_Avg_Lumi/ \
| sed -e s/DO_CORR/True/ \
| sed -e s/DO_PVS/False/ \
| sed -e s/MAX_NPVS/4/ \
| sed -e s/PV_COLLECTION/offlinePrimaryVertices/ \
...
# | sed -e s/OUTPUT_FILENAME/QCDpt15_plus_2PU_Full_Poisson/ \
# | sed -e s/OFFSET_CORRECTION/False/ \
# | sed -e s/NUMBER_OF_PU/2PU/ \
# > $CONFIG_FILE
# 
...
#==========================================================
# echo "`/bin/date` >> QCDpt15_plus_2PU_Full_Poisson_corrected analysis started..."
# 
# cat $CONFIG_FILE_TEMPLATE \
# | sed -e s/INPUT_POOLSOURCE/QCDpt15_plus_2PU_Full_Poisson/ \
# | sed -e s/OUTPUT_FILENAME/QCDpt15_plus_2PU_Full_Poisson_corrected/ \
# | sed -e s/OFFSET_CORRECTION/True/ \
# | sed -e s/NUMBER_OF_PU/2PU/ \
# > $CONFIG_FILE
# 
# cmsRun $CONFIG_FILE >& QCDpt15_plus_2PU_Full_Poisson_corrected.log 
# 
# echo "`/bin/date` >> QCDpt15_plus_2PU_Full_Poisson_corrected analysis completed!"
#==========================================================
...
| sed -e s/OUTPUT_FILENAME/closureAnalysis_QCDpt15_plus_5PU_InTime_Poisson/ \
| sed -e s/DO_CORR/False/ \
| sed -e s/DO_PVS/False/ \
| sed -e s/MAX_NPVS/4/ \
| sed -e s/PV_COLLECTION/offlinePrimaryVertices/ \
...
| sed -e s/MAX_EVTS/-1/ \
| sed -e s/INPUT_POOLSOURCE/QCDpt15_plus_5PU_InTime_Poisson/ \
| sed -e s/OUTPUT_FILENAME/closureAnalysis_QCDpt15_plus_5PU_InTime_Poisson_corrected_Avg_Lumi/ \
| sed -e s/DO_CORR/True/ \
| sed -e s/DO_PVS/False/ \
| sed -e s/MAX_NPVS/4/ \
| sed -e s/PV_COLLECTION/offlinePrimaryVertices/ \
...
# | sed -e s/OUTPUT_FILENAME/QCDpt15_plus_5PU_Full_Poisson/ \
# | sed -e s/OFFSET_CORRECTION/False/ \
# | sed -e s/NUMBER_OF_PU/5PU/ \
# > $CONFIG_FILE
# 
...
#==========================================================
# echo "`/bin/date` >> QCDpt15_plus_5PU_Full_Poisson_corrected analysis started..."
# 
# cat $CONFIG_FILE_TEMPLATE \
# | sed -e s/INPUT_POOLSOURCE/QCDpt15_plus_5PU_Full_Poisson/ \
# | sed -e s/OUTPUT_FILENAME/QCDpt15_plus_5PU_Full_Poisson_corrected/ \
# | sed -e s/OFFSET_CORRECTION/True/ \
# | sed -e s/NUMBER_OF_PU/5PU/ \
# > $CONFIG_FILE
# 
# cmsRun $CONFIG_FILE >& QCDpt15_plus_5PU_Full_Poisson_corrected.log 
# 
# echo "`/bin/date` >> QCDpt15_plus_5PU_Full_Poisson_corrected analysis completed!"
#==========================================================
