...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('closureAnalysis_sisCone5_QCDpt15_plus_5PU_Full_Poisson_corrected_Avg_Lumi_ET0.5.root')
)
...
process.closureAnalysis = cms.EDAnalyzer('ClosureAnalysis',
    ...
    iso_deltaR     = cms.double(0.),
    doCorr         = cms.bool(True),
    doPVs          = cms.bool(False),
    maxNPVs        = cms.int32(4),
    pvCollection   = cms.InputTag('offlinePrimaryVertices'),
    offsetCorrPath = cms.string('/uscmst1b_scratch/lpc1/lpcphys/ferencek/CMSSW_2_1_8/src/AnalysisCode/OffsetAnalysis/test/root_files/5PU_Full_Poisson_ET0.5.root')
)
