...
void overlay_plots(const string& fFile0, const string& fFile1, const string& fPlot, const string& fName) {
...
void makePlots() {
   ...
   // make plots
   //********************************************
   overlay_plots(MC_noise, data_ZB, "p_AvgEinC5", "p_AvgEinC5_NoiseMC_vs_ZB_R123596.png");
   overlay_plots(MC_noise, data_ZB, "p_AvgpTinC5", "p_AvgpTinC5_NoiseMC_vs_ZB_R123596.png");;
}