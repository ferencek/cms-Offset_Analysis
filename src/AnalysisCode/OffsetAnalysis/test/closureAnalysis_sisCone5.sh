...
CONFIG_FILE_TEMPLATE=`echo closureAnalysis_sisCone5_template_cfg.py`
CONFIG_FILE=`echo closureAnalysis_sisCone5_cfg.py`
...
| sed -e s/OUTPUT_FILENAME/closureAnalysis_sisCone5_QCDpt15_NN/ \
...
# | sed -e s/OUTPUT_FILENAME/closureAnalysis_sisCone5_QCDpt15_plus_1PU_InTime_Poisson/ \
# | sed -e s/DO_CORR/False/ \
# | sed -e s/DO_PVS/False/ \
# | sed -e s/MAX_NPVS/4/ \
# | sed -e s/PV_COLLECTION/offlinePrimaryVertices/ \
...
# | sed -e s/MAX_EVTS/-1/ \
# | sed -e s/INPUT_POOLSOURCE/QCDpt15_plus_1PU_InTime_Poisson/ \
# | sed -e s/OUTPUT_FILENAME/closureAnalysis_sisCone5_QCDpt15_plus_1PU_InTime_Poisson_corrected_Avg_Lumi/ \
...
| sed -e s/OUTPUT_FILENAME/closureAnalysis_sisCone5_QCDpt15_plus_1PU_Full_Poisson/ \
| sed -e s/DO_CORR/False/ \
| sed -e s/DO_PVS/False/ \
| sed -e s/MAX_NPVS/4/ \
| sed -e s/PV_COLLECTION/offlinePrimaryVertices/ \
...
| sed -e s/MAX_EVTS/-1/ \
| sed -e s/INPUT_POOLSOURCE/QCDpt15_plus_1PU_Full_Poisson/ \
| sed -e s/OUTPUT_FILENAME/closureAnalysis_sisCone5_QCDpt15_plus_1PU_Full_Poisson_corrected_Avg_Lumi/ \
| sed -e s/DO_CORR/True/ \
| sed -e s/DO_PVS/False/ \
| sed -e s/MAX_NPVS/4/ \
| sed -e s/PV_COLLECTION/offlinePrimaryVertices/ \
...
# | sed -e s/OUTPUT_FILENAME/closureAnalysis_sisCone5_QCDpt15_plus_2PU_InTime_Poisson/ \
# | sed -e s/DO_CORR/False/ \
# | sed -e s/DO_PVS/False/ \
# | sed -e s/MAX_NPVS/4/ \
# | sed -e s/PV_COLLECTION/offlinePrimaryVertices/ \
...
# | sed -e s/MAX_EVTS/-1/ \
# | sed -e s/INPUT_POOLSOURCE/QCDpt15_plus_2PU_InTime_Poisson/ \
# | sed -e s/OUTPUT_FILENAME/closureAnalysis_sisCone5_QCDpt15_plus_2PU_InTime_Poisson_corrected_Avg_Lumi/ \
# | sed -e s/DO_CORR/True/ \
# | sed -e s/DO_PVS/False/ \
# | sed -e s/MAX_NPVS/4/ \
# | sed -e s/PV_COLLECTION/offlinePrimaryVertices/ \
...
| sed -e s/OUTPUT_FILENAME/closureAnalysis_sisCone5_QCDpt15_plus_2PU_Full_Poisson/ \
| sed -e s/DO_CORR/False/ \
| sed -e s/DO_PVS/False/ \
| sed -e s/MAX_NPVS/4/ \
| sed -e s/PV_COLLECTION/offlinePrimaryVertices/ \
...
| sed -e s/MAX_EVTS/-1/ \
| sed -e s/INPUT_POOLSOURCE/QCDpt15_plus_2PU_Full_Poisson/ \
| sed -e s/OUTPUT_FILENAME/closureAnalysis_sisCone5_QCDpt15_plus_2PU_Full_Poisson_corrected_Avg_Lumi/ \
| sed -e s/DO_CORR/True/ \
| sed -e s/DO_PVS/False/ \
| sed -e s/MAX_NPVS/4/ \
| sed -e s/PV_COLLECTION/offlinePrimaryVertices/ \
...
# | sed -e s/OUTPUT_FILENAME/closureAnalysis_sisCone5_QCDpt15_plus_5PU_InTime_Poisson/ \
# | sed -e s/DO_CORR/False/ \
# | sed -e s/DO_PVS/False/ \
# | sed -e s/MAX_NPVS/4/ \
# | sed -e s/PV_COLLECTION/offlinePrimaryVertices/ \
...
# | sed -e s/MAX_EVTS/-1/ \
# | sed -e s/INPUT_POOLSOURCE/QCDpt15_plus_5PU_InTime_Poisson/ \
# | sed -e s/OUTPUT_FILENAME/closureAnalysis_sisCone5_QCDpt15_plus_5PU_InTime_Poisson_corrected_Avg_Lumi/ \
# | sed -e s/DO_CORR/True/ \
# | sed -e s/DO_PVS/False/ \
# | sed -e s/MAX_NPVS/4/ \
# | sed -e s/PV_COLLECTION/offlinePrimaryVertices/ \
...
| sed -e s/OUTPUT_FILENAME/closureAnalysis_sisCone5_QCDpt15_plus_5PU_Full_Poisson/ \
| sed -e s/DO_CORR/False/ \
| sed -e s/DO_PVS/False/ \
| sed -e s/MAX_NPVS/4/ \
| sed -e s/PV_COLLECTION/offlinePrimaryVertices/ \
...
| sed -e s/MAX_EVTS/-1/ \
| sed -e s/INPUT_POOLSOURCE/QCDpt15_plus_5PU_Full_Poisson/ \
| sed -e s/OUTPUT_FILENAME/closureAnalysis_sisCone5_QCDpt15_plus_5PU_Full_Poisson_corrected_Avg_Lumi/ \
| sed -e s/DO_CORR/True/ \
| sed -e s/DO_PVS/False/ \
| sed -e s/MAX_NPVS/4/ \
| sed -e s/PV_COLLECTION/offlinePrimaryVertices/ \
