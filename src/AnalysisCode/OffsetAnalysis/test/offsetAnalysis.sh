...
| sed -e s/OUTPUT_FILENAME/Noise-only_ET0.5/ \
...
# | sed -e s/OUTPUT_FILENAME/1PU_InTime_Fixed_ET0.5/ \
# | sed -e s/DO_OFFSET/True/ \
# | sed -e s/DO_PVS/False/ \
# | sed -e s/MAX_NPVS/0/ \
# | sed -e s/PV_COLLECTION/offlinePrimaryVertices/ \
...
| sed -e s/OUTPUT_FILENAME/1PU_InTime_Poisson_ET0.5/ \
| sed -e s/DO_OFFSET/True/ \
| sed -e s/DO_PVS/False/ \
| sed -e s/MAX_NPVS/0/ \
| sed -e s/PV_COLLECTION/offlinePrimaryVertices/ \
...
| sed -e s/OUTPUT_FILENAME/1PU_Full_Poisson_ET0.5/ \
| sed -e s/DO_OFFSET/True/ \
| sed -e s/DO_PVS/False/ \
| sed -e s/MAX_NPVS/0/ \
| sed -e s/PV_COLLECTION/offlinePrimaryVertices/ \
...
# | sed -e s/OUTPUT_FILENAME/2PU_InTime_Fixed_ET0.5/ \
# | sed -e s/DO_OFFSET/True/ \
# | sed -e s/DO_PVS/False/ \
# | sed -e s/MAX_NPVS/0/ \
# | sed -e s/PV_COLLECTION/offlinePrimaryVertices/ \
...
| sed -e s/OUTPUT_FILENAME/2PU_InTime_Poisson_ET0.5/ \
| sed -e s/DO_OFFSET/True/ \
| sed -e s/DO_PVS/False/ \
| sed -e s/MAX_NPVS/0/ \
| sed -e s/PV_COLLECTION/offlinePrimaryVertices/ \
...
| sed -e s/OUTPUT_FILENAME/2PU_Full_Poisson_ET0.5/ \
| sed -e s/DO_OFFSET/True/ \
| sed -e s/DO_PVS/False/ \
| sed -e s/MAX_NPVS/0/ \
| sed -e s/PV_COLLECTION/offlinePrimaryVertices/ \
...
# | sed -e s/OUTPUT_FILENAME/5PU_InTime_Fixed_ET0.5/ \
# | sed -e s/DO_OFFSET/True/ \
# | sed -e s/DO_PVS/False/ \
# | sed -e s/MAX_NPVS/0/ \
# | sed -e s/PV_COLLECTION/offlinePrimaryVertices/ \
...
| sed -e s/OUTPUT_FILENAME/5PU_InTime_Poisson_ET0.5/ \
| sed -e s/DO_OFFSET/True/ \
| sed -e s/DO_PVS/False/ \
| sed -e s/MAX_NPVS/0/ \
| sed -e s/PV_COLLECTION/offlinePrimaryVertices/ \
...
| sed -e s/OUTPUT_FILENAME/5PU_Full_Poisson_ET0.5/ \
| sed -e s/DO_OFFSET/True/ \
| sed -e s/DO_PVS/False/ \
| sed -e s/MAX_NPVS/0/ \
| sed -e s/PV_COLLECTION/offlinePrimaryVertices/ \
